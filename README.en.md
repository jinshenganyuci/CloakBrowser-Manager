> This is the preserved upstream documentation. For this Chinese fork, build from [jinshenganyuci/CloakBrowser-Manager](https://github.com/jinshenganyuci/CloakBrowser-Manager) and follow [the Chinese README](README.md). Upstream Docker images do not contain the changes in this fork.
